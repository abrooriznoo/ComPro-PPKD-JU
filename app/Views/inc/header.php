        ...
        <div class="collapse navbar-collapse ms-5" id="navbarNav">
            <ul class="navbar-nav mb-2 mb-lg-0 mx-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="pelatihanDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Pelatihan
                    </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="pendaftaranDropdown">
                        ...
                        <li><a class="dropdown-item" href="https://ppkdju.com/pendaftaran-mtu">Mobile Training Unit (MTU)</a></li>
