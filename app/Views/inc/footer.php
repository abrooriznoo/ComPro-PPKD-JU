<div class="container-fluid px-0">
    <div class="card d-flex" style="background-color: rgb(56, 60, 61); border-radius: 0; font-size: 0.85rem;">
        <div class="card-body text-white">
            <div class="row p-3">
                <div class="col-md-3">
                    <div class="mb-3">
                        <h4 style="font-size:1.2rem;">PPKD Jakarta Utara</h4>
                    </div>
                    <p>Jalan Raya Gereja Tugu No 20 Semper Barat Cilincing, Kota Administrasi Jakarta Utara</p>
                    <p><b>Telp : </b>021‑4401066</p>
        ...
        <div class="card text-white" style="background-color: rgba(42, 45, 45, 1); font-size:0.85rem;">
            <div class="p-3">
